const Countries = [
    ...
    { label: "Palau", id: "PW" },
    { label: "Palestine, State of", id: "PS" },
    { label: "Panama", id: "PA" },
    ...
    { label: "Saint Helena, Ascension and Tristan da Cunha", id: "SH" },
    { label: "Saint Kitts and Nevis", id: "KN" },
    { label: "Saint Lucia", id: "LC" },
    { label: "Saint Martin (French part)", id: "MF" },
    ...
    { label: "Sint Maarten (Dutch part)", id: "SX" },
    ...
    { label: "Vanuatu", id: "VU" },
    { label: "Venezuela, Bolivarian Republic of", id: "VE" },
